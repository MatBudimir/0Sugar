    ...
    function story(storyPart: string) {
        switch (storyPart) {
            ...
            case "2A":
                ...
                decision(narration, "A", "B", "3A", "3B", false);
                break;
            case "2B":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "3C", "3D", false);
                break;
            case "3A":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "4A", "4B", false);
                break;
            case "3B":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "4C", "4D", false);
                break;
            case "3C":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "4E", "4F", false);
                break;
            case "3D":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "4G", "4H", false);
                break;
            case "4A":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "5A", "5B", false);
                break;
            case "4B":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "5C", "5D", false);
                break;
            case "4C":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "5E", "5F", false);
                break;
            case "4D":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "5G", "5H", false);
                break;
            case "4H":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "5I", "5J", false);
                break;
            case "4I":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "5K", "5L", false);
                break;
            case "4J":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "5M", "5N", false);
                break;
            case "4K":
                narration = "you chose right: A or B";
                decision(narration, "A", "B", "5O", "5P", false);
                break;
            case "5A":
                narration = "you chose right: A or B";
