namespace GoblinBoi {
    ...
    function ChooseTask(): void {
        let tasks: string = prompt("You have a long day ahead of you. Looking around your damp cave you notice a few things you need take care of, but you only have time for one. You could gather some [wood] for the firepit, gather some [herbs] for your kitchen, fetch [water] for your morning bath, or [set traps] for those pesky adventurers.", "What do you do?")!
        switch (tasks) {
            case "wood":
    ...
    function ChooseTrap(): void {
        let trap: string = prompt("The adventurer's are aproaching and you only have time to set up one trap. You could set a [fire], dig a [pit], rain down [rocks] on them, or [ambush] them.", "Make a choice.")!
        switch (trap) {
            case "fire":
